    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetPasswordSuccess ? "Password has set."
                : message == ManageMessageId.SetTwoFactorSuccess ? "Настроен поставщик двухфакторной проверки подлинности."
                : message == ManageMessageId.Error ? "Error."
                : message == ManageMessageId.AddPhoneSuccess ? "Your phone was added."
                : message == ManageMessageId.RemovePhoneSuccess ? "Your phone has been deleted"
                : "";
